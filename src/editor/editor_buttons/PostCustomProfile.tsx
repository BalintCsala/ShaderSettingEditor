...
export default function PostCustomProfile(props: Props) {
    ...
    return (
        <>
            <Button class="flex grow basis-1 flex-col items-center md:grow-0 md:flex-row" onClick={() => setState(PostState.Setup)}>
                <Icon icon="upload" class="text-6xl sm:text-3xl md:mr-2" />
                <span class="hidden whitespace-nowrap sm:inline">Upload profile</span>
            </Button>
                    ...
                    <Switch>
                        ...
                        <Match when={state() === PostState.Authentication}>
                            <p class="text-lg text-primary-400">
                                To post a custom profile, you'll have to authenticate first. This is handled by Firebase, we do not ever receive your password
                                and only store a unique user ID for spam regulation.
                            </p>
                        ...
                        <Match when={state() === PostState.Disclaimer}>
                            ...
                            <ul class="list-dashed">
                                ...
                                <li class="text-lg text-primary-400">Your submission doesn't circumvent any of the in-place safety measures against spam.</li>
                            </ul>
