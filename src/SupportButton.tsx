        ...
        <>
            ...
            <Show when={active()}>
                <ModalContainer onClose={() => setActive(false)}>
                    <span class="mb-2 block w-full text-center text-3xl text-primary-400">
                        Support options
                    </span>
                    <p class="mb-6 w-full text-center text-xl text-primary-400">
                        We accept donations through the following services:
                    </p>
                    ...
                    <p class="mt-6 w-full text-center text-primary-400">
                        All donations go towards development and upkeep costs.
                    </p>
                </ModalContainer>
            </Show>
        </>
